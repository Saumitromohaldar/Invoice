...
@section('content')
    ...
    <div class="row">
        ...
        <div class="box box-info">
            ...
            <form method="POST" id="save-category" action="{{route('categories.update',$category->id)}}">
                @csrf
                @method('PUT')
                <div class="box-body">
                    ...
                    <div class="col-md-12">  
                        ...
                        <div class="form-group {{ $errors->has('type') ? 'has-error' :'' }}">
                            ...
                            {!! Form::select('type', ['Income'=>'Income','Expense'=>'Expense'], $category->type,['class' => 'form-control select2','placeholder'=>'Select Type' ,'id'=>'district']) !!}                            
