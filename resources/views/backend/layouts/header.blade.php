 <header class="main-header">
    ...
    <a href="{{url('/')}}" class="logo">
      ...
      <span class="logo-mini"><img src="{{asset('backend/images/logo.png')}}" alt="Rakib Trade"></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img src="{{asset('backend/images/logo.png')}}" alt="Rakib Trade"></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{url('backend/dist/img/me.jpg')}}" class="user-image" alt="User Image">
